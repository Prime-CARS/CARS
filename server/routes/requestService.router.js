...
router.post('/', function(req,res){
    ...
    pool.connect (function(errorConnectingToDatabase, client, done){
        ...
        if(errorConnectingToDatabase){ //if the connection failed
            ...
            client.query('INSERT INTO customer_info (name, address, city, state, zip, cellphone, alternative_phone, email_address, qualify_input) VALUES ($1, $2, $3, $4, $5, $6, $7, $8, $9);', [req.body.name, req.body.address, req.body.city, req.body.state, req.body.zip, req.body.cellPhone, req.body.altPhone, req.body.email, req.body.qualification], function(errorMakingQuery, result) {
                done();
                if(errorMakingQuery) {
...
router.post('/', function(req, res){
    ...
    // console.log("vehicle information: ", req.body);
    // console.log("Vehicle information:", vehicle);
    console.log("The post route  for vehicles  on line 40 in requestService.router.js was hit");
    //connecting to db
    pool.connect (function(errorConnectingToDatabase, client, done){
        //checking the status of the connection
        if(errorConnectingToDatabase){ //if the connection failed
            ...
            client.query('INSERT INTO vehicle_info (year, make, model, vin, service_request) VALUES ($1, $2, $3, $4, $5);',[vehicle.year, vehicle.make, vehicle.model, vehicle.vin, vehicle.problem],  function(errorMakingQuery, result) {
                done();
                if(errorMakingQuery) {
